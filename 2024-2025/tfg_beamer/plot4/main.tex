...
\begin{tikzpicture}
    \begin{axis}[
        ...
        ymin = -10,
        ymax = 50,
        samples = 500, % si pongo más o menos salen picos
    ...
    \addplot[domain=-pi:pi, color=c2, line width=2pt]{sin(deg((20+1/2)*x))/sin(deg(x/2))};
    \addlegendentry{\footnotesize $D_{20}$};
    \end{axis}
    \begin{axis}[
        ticks = none,
        xmin = -pi,
